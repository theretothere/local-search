...
public class Controller {
    ...
    @FXML
    public TableView<sample.Student> tableView;
    // thread 的所有读写操作其实都在主线程中，所以不需要考虑线程安全的问题
    private Thread thread = null;

    private int id = 1;
    private final Random random = new Random(20200118);
    ...
    private void addStudent(String name){
        ...
        sample.Student student = new sample.Student(id++, name , age , gender );

        ObservableList<sample.Student> items = tableView.getItems();
        items.add(student);
